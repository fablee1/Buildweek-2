        ...
        <div className="d-flex justify-content-between pt-2">
          ...
          <div className={styles.rightPanel}>
            <ul>
              <RightPanelItem
                title="Strive School"
                img="https://media-exp1.licdn.com/dms/image/C4D0BAQFFQIjyDsOK0w/company-logo_100_100/0/1593351903670?e=1631750400&v=beta&t=Z5VOepdFNLxZjBwg4bbfh5VFFJEUssCa9yTLNI8CxUM"
              />
            </ul>
          </div>
        </div>
      ...
      {!props.public && (
        <div className={`${styles.carousel} d-flex`}>
          <CarouselCard
            edit
            title="Open to work"
            text="Web Developer and Software Associate roles"
          />
          <CarouselCard
      ...
      <div className="d-flex">
        <a href="/">
          <div className={styles.carouselCardText}>
            ...
            <p className={styles.blueLink}>
              {props.edit ? "See all details" : "Get started"}
            </p>
          </div>
        </a>
